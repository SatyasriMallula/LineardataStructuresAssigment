...
let arrayList = [11, 12, 3, 41, 3, 2, 10];
...
function reverse(head1, k) {
    ...
    if (next != null)
        head1.next = reverse(next, k);
    return prev;
}
function push(new_data) {

    let new_node = new Node1(new_data);
    new_node.next = head1;
    head1 = new_node;
}
function printList() {
